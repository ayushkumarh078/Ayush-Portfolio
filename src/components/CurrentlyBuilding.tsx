    ...
    <section id="currently-building" className="py-32 px-6 relative z-10">
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-black text-white tracking-tight">Currently Building</h2>
        </motion.div>
            ...
            <div className="flex flex-col lg:flex-row gap-12">
              ...
              <div className="flex-1">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <h4 className="flex items-center gap-2 text-white/80 font-medium mb-3 text-sm">
                      <Terminal size={16} className="text-indigo-400" /> Recent Commits
                    </h4>
              ...
              <div className="flex-1 lg:max-w-sm">
                <div className="bg-white/[0.03] rounded-2xl border border-white/10 p-6 md:p-8 h-full">
                  ...
                  <div className="space-y-6 relative before:absolute before:inset-0 before:ml-[11px] before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-indigo-500/50 before:to-transparent">
                    
                    <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                      <div className="flex items-center justify-center w-6 h-6 rounded-full border border-emerald-500 bg-black z-10 shrink-0">
                    ...
                    <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                      <div className="flex items-center justify-center w-6 h-6 rounded-full border border-indigo-500 bg-black z-10 shrink-0">
