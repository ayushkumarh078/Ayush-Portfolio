          ...
          <div className="p-8 md:p-12 relative z-10">
            <div className="flex flex-col lg:flex-row gap-12">
              ...
              <div className="flex-1">
                ...
                <h3 className="text-3xl font-bold text-white mb-4">DevLens (GitHub Project Analyzer)</h3>
                ...
                <div className="space-y-6">
                  <div>
                    <h4 className="flex items-center gap-2 text-white/80 font-medium mb-3 text-sm">
                      <Cpu size={16} className="text-gold" /> Tech Stack
                    </h4>
                    <ul className="space-y-2 text-sm text-white/50 font-mono">
                      <li className="flex items-start gap-2"><span className="text-gold-muted">▹</span> Next.js, Tailwind, shadcn for UI</li>
                      <li className="flex items-start gap-2"><span className="text-gold-muted">▹</span> FastAPI (Python) Backend</li>
                      <li className="flex items-start gap-2"><span className="text-gold-muted">▹</span> GitPython, Tree-sitter, NetworkX for static analysis</li>
                    </ul>
                  </div>

                  <div>
                    <h4 className="flex items-center gap-2 text-white/80 font-medium mb-3 text-sm">
                      <Terminal size={16} className="text-gold" /> Recent Milestones
                    </h4>
                    <div className="bg-black/40 rounded-xl border border-white/5 p-4 space-y-3 font-mono text-xs">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <p className="text-white/70">Implement temporary workspace cloning and AST parsing</p>
                          <span className="text-white/30">Just started</span>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        <GitCommit size={14} className="text-white/30 mt-0.5 shrink-0" />
                        <div>
                          <p className="text-white/70">Design Phase 1 Repository Intelligence dashboard</p>
              ...
              <div className="flex-1 lg:max-w-sm">
                <div className="bg-white/[0.03] rounded-2xl border border-white/10 p-6 md:p-8 h-full">
                  <h4 className="text-lg font-bold text-white mb-6">Execution Roadmap</h4>
                  ...
                  <div className="space-y-6 relative before:absolute before:inset-0 before:ml-[11px] before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-gold/50 before:to-transparent">
                    ...
                    <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                      ...
                      <div className="w-[calc(100%-2.5rem)] md:w-[calc(50%-2rem)] p-4 rounded-xl border border-gold/30 bg-gold/10 shadow-[0_0_15px_rgba(212,175,55,0.1)]">
                        <h5 className="font-bold text-white text-sm mb-1">Phase 1 (MVP)</h5>
                        <p className="text-gold-muted/70 text-xs">Repo Intelligence (No LLMs). Detect structure, architecture, dependencies.</p>
                      </div>
                    </div>
                    ...
                    <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
                      ...
                      <div className="w-[calc(100%-2.5rem)] md:w-[calc(50%-2rem)] p-4 rounded-xl border border-white/5 bg-white/[0.02]">
                        <h5 className="font-bold text-white/50 text-sm mb-1">Phase 2</h5>
                        <p className="text-white/30 text-xs">AI Understanding: Ask Repo, Code Explanations, Diagram Gen.</p>
                      </div>
                    </div>
                    ...
                    <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
                      ...
                      <div className="w-[calc(100%-2.5rem)] md:w-[calc(50%-2rem)] p-4 rounded-xl border border-white/5 bg-white/[0.02]">
                        ...
                        <p className="text-white/30 text-xs">Team Features: PR Reviews, CI/CD, Tech Debt Tracking.</p>
                      </div>
                    </div>
                  </div>
